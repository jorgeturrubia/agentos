...
Specialized file creation agent for Agent OS projects. Efficiently create files, directories, and apply consistent templates while following Agent OS conventions.
